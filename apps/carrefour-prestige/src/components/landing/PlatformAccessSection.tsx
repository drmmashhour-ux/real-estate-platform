...
export function PlatformAccessSection() {
  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_center,_rgba(201,166,70,0.08)_0%,_transparent_55%)]" />
      <div className="relative mx-auto max-w-3xl px-6 text-center">
        ...
        <a
          ...
          className="mt-10 inline-flex items-center justify-center rounded-lg bg-[#C9A646] px-12 py-4 text-base font-semibold text-[#0B0B0B] shadow-[0_12px_40px_rgba(201,166,70,0.35)] transition hover:bg-[#b8943d]"
        >
          Access Platform
