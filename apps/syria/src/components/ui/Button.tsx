...
export function Button({
  ...
  return (
    <button
      type={type}
      className={cn(
        "inline-flex items-center justify-center rounded-[var(--darlink-radius-xl)] px-4 py-2.5 text-sm font-semibold text-white transition disabled:opacity-50",
