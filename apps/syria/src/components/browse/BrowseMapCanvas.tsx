    ...
    <div className="relative flex flex-col gap-2">
      ...
      {onSearchThisArea ? (
        <button
          ...
          className="absolute bottom-3 left-1/2 z-[1] min-h-[44px] -translate-x-1/2 rounded-full bg-[color:var(--darlink-accent)] px-5 py-2.5 text-sm font-semibold text-white shadow-[var(--darlink-shadow-md)] hover:opacity-[0.96]"
        >
          {searchAreaLabel}
        </button>
      ) : null}
