...
export default async function HomePage() {
  ...
  return (
    <div className="space-y-16 sm:space-y-20">
      ...
      <section className="relative overflow-hidden rounded-[var(--darlink-radius-3xl)] border border-white/5 bg-[color:var(--darlink-bg)] text-white shadow-[var(--darlink-shadow-md)]">
        <div className="relative px-6 py-12 sm:px-10 sm:py-14 lg:py-16">
          ...
          <div className="darlink-rtl-row mt-8 flex w-full flex-col gap-3 min-[480px]:flex-row min-[480px]:flex-wrap">
            <Link
              href="/buy"
              className="inline-flex min-h-[44px] w-full items-center justify-center rounded-[var(--darlink-radius-xl)] border border-white/25 bg-white/10 px-6 py-3 text-sm font-semibold text-white backdrop-blur transition hover:bg-white/15 min-[480px]:w-auto"
            >
              {t("ctaExploreListings")}
            </Link>
            <Link
              href="/sell"
              className="hadiah-btn-primary inline-flex min-h-[44px] w-full min-w-[44px] items-center justify-center rounded-[var(--darlink-radius-xl)] px-6 py-3 text-sm font-semibold shadow-[var(--darlink-shadow-md)] transition min-[480px]:w-auto"
            >
              {t("ctaPost")}
            </Link>
            <Link
      ...
      <section>
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-3">
          ...
          <Link
            href="/bnhub/stays"
            className="rounded-[var(--darlink-radius-2xl)] border border-[color:var(--darlink-border)] bg-[color:var(--darlink-surface)] p-6 shadow-[var(--darlink-shadow-sm)] hover:border-[color:var(--darlink-accent)]/30"
          >
