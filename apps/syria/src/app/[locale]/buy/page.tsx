...
/** ORDER SYBNB-82 / SYBNB-104 — sync literal with `SYRIA_PUBLIC_SEGMENT_REVALIDATE_SECONDS` (next requires a number here). */
...
export default async function BuyPage(props: Props) {
  ...
  const initialResult = await getCachedBrowseSearch("sale", flat);
