      ...
      <MapRequiredSellForm action={createPropertyListing} className="space-y-5 rounded-2xl border border-stone-200 bg-white p-6 shadow-sm">
        ...
        <fieldset className="rounded-xl border border-stone-200 bg-stone-50/80 p-4">
          ...
          <div className="mt-3 space-y-3">
            <label className="flex cursor-pointer gap-3 rounded-lg border border-transparent p-2 transition hover:border-stone-200 hover:bg-white">
            ...
            <label className="flex cursor-pointer gap-3 rounded-lg border border-transparent p-2 transition hover:border-amber-200/80 hover:bg-white">
