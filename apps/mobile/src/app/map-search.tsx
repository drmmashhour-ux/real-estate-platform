    ...
    <SafeAreaView style={styles.safe} edges={["top", "left", "right"]}>
      <View style={styles.header}>
        ...
        <Text style={styles.sub}>
          Pins use `latitude` / `longitude` on listings when set (see marketplace SQL). Otherwise you see the default region.
        </Text>
      </View>
      ...
      <View style={styles.footer}>
        <Text style={styles.footerNote}>
          {withCoords.length === 0
            ? "No geocoded listings yet. Apply `supabase-listings-marketplace-extensions.sql` and set coordinates."
