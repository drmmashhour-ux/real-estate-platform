...
import { ShareMyStayButton } from "@/components/bnhub/share-my-stay";
            ...
            <div className="flex flex-1 flex-col justify-between p-4">
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">
                  Booking total ${((b.totalCents + b.guestFeeCents) / 100).toFixed(2)}
              ...
              <div className="mt-3 flex flex-wrap gap-2">
                ...
                {(String(b.status).toUpperCase() === "CONFIRMED" ||
                  ...
                  <ShareMyStayButton bookingId={b.id} variant="subtle" />
                )}
                <Link
