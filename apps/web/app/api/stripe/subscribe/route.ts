...
export async function POST(req: NextRequest) {
  ...
  const checkout = await stripe.checkout.sessions.create({
    ...
    success_url: `${base}/dashboard/expert/billing?checkout=success`,
    cancel_url: `${base}/dashboard/expert/billing?checkout=cancel`,
    metadata: {
      paymentType: MORTGAGE_EXPERT_CHECKOUT_PAYMENT_SUB,
      expertId: expert.id,
      plan,
    },
    subscription_data: {
