...
import { markNotificationRead } from "@/modules/notifications/services/create-notification";
...
export async function POST(request: NextRequest, ctx: Ctx) {
  ...
  const updated = await markNotificationRead(id, user.userId, user.userId);
