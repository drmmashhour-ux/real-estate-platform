...
/**
 * POST /api/admin/verifications/:id/reject — Reject listing verification (id = listingId).
...
export async function POST(
  ...
  try {
    ...
    const result = await setVerificationDecision(listingId, "REJECTED", adminId, notes);
    if (!result.ok) {
