  ...
  return (
    <div className="min-h-screen bg-[#0B0B0B] text-white">
      ...
      <main className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
        <p className="text-[11px] font-bold uppercase tracking-[0.2em] text-[#C9A646]">Rent Hub · Lease</p>
          ...
          <div className="mt-8 space-y-4 text-sm text-[#B3B3B3]">
            ...
            {lease.status === "ACTIVE" ? (
              <p>
                ...
                or{" "}
                <Link href="/dashboard/landlord/payments" className="text-[#C9A646] hover:underline">
                  landlord payments
                </Link>
                .
              </p>
