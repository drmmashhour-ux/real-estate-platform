  ...
  return (
    <main className="min-h-screen bg-[#0B0B0B] text-white">
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <Link
          href="/admin"
          className="text-sm font-medium text-[#C9A646] transition hover:text-[#E8C547]"
        >
          ← Admin
        </Link>
        <header className="mt-6 border-b border-white/10 pb-6">
          ...
          <p className="mt-2 max-w-3xl text-sm text-[#B3B3B3]">
            ...
            <code className="text-[#E8C547]">?source=</code>, <code className="text-[#E8C547]">?campaign=</code>,{" "}
            <code className="text-[#E8C547]">?medium=</code> (or UTM) set first-touch attribution.{" "}
