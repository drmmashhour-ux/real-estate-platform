  ...
  return (
    <main className="min-h-screen bg-slate-950 px-4 py-8 text-slate-50">
      <div className="mx-auto max-w-6xl">
        ...
        <h1 className="mt-4 text-2xl font-semibold">Market data (trend analysis)</h1>
        <p className="mt-2 max-w-2xl text-sm text-slate-400">
          Upload monthly snapshots for cities and property types. Values feed the public{" "}
          <Link href="/market" className="text-amber-400 underline">
            /market
          </Link>{" "}
          trend analysis (estimates only — not guarantees).
        </p>
