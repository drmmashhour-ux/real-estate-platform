      ...
      <div className="space-y-8">
        <div>
          ...
          <p className="mt-2 text-sm text-slate-400">
            ...
            <Link href="/admin/ai" className="text-[#C9A646] hover:underline">
              AI Control Center
            </Link>
            .
          </p>
        ...
        {[daily, weekly, monthly].map((r) => (
          <section
            key={r.period}
            className="rounded-2xl border border-[#C9A646]/25 bg-[#0a0a0a] p-6"
          >
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#C9A646]">{r.period}</p>
