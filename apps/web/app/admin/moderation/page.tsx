  ...
  return (
    <main className="min-h-screen bg-slate-950 text-slate-50">
      <div className="mx-auto max-w-6xl px-4 py-8">
        ...
        <h1 className="mt-4 text-2xl font-semibold">Moderation case files</h1>
        <p className="mt-1 text-slate-400">
          Each row is a packet-backed verification case. Review hosting checklist status, notify hosts, and open listing case files before approval or rejection.
        </p>
