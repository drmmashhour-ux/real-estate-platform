      ...
      <div className="mx-auto max-w-4xl px-4 py-10 sm:px-6">
          ...
          {(
            ...
            <button
              ...
              className={`rounded-xl px-4 py-2 text-sm font-semibold ${
                tab === k ? "bg-premium-gold text-[#0B0B0B]" : "border border-white/15 text-[#B3B3B3]"
              }`}
            >
              {label}
            </button>
        ...
        {tab === "scripts" ? (
          <section className="mt-8 space-y-6">
            ...
            <div className="rounded-2xl border border-premium-gold/30 bg-[#121212] p-6">
              <h2 className="text-lg font-bold text-premium-gold">{demoScript.title}</h2>
              <dl className="mt-4 space-y-4 text-sm">
                ...
                <div>
                  ...
                  <dd className="mt-1 text-premium-gold">{demoScript.closingQuestion}</dd>
                </div>
              </dl>
            </div>
          ...
          <ul className="mt-8 space-y-4">
            {ASSISTANT_OBJECTIONS.map((o) => (
              <li key={o.id} className="rounded-2xl border border-white/10 bg-[#121212] p-5">
                <p className="font-semibold text-premium-gold">{o.objection}</p>
                <p className="mt-2 text-sm font-medium text-premium-gold">{o.shortAnswer}</p>
        ...
        {tab === "structure" ? (
          <section className="mt-8 rounded-2xl border border-premium-gold/30 bg-[#121212] p-6">
            <h2 className="text-lg font-bold text-premium-gold">Call structure</h2>
            ...
            <p className="mt-6 text-xs text-[#737373]">
              On a live lead, open <span className="text-premium-gold">Start call mode</span> or use{" "}
              <Link href="/dashboard/leads" className="text-premium-gold hover:underline">
                Sales Assistant
              </Link>{" "}
              on any lead.
            </p>
        ...
        {tab === "closing" ? (
          <section className="mt-8 rounded-2xl border border-premium-gold/30 bg-[#121212] p-6">
            <h2 className="text-lg font-bold text-premium-gold">Closing techniques</h2>
        ...
        {tab === "practice" ? (
          <div className="mt-8 rounded-2xl border border-premium-gold/25 bg-[#121212] p-6">
        ...
        {tab === "roleplay" ? (
          <section className="mt-8 rounded-2xl border border-premium-gold/40 bg-[#121212] p-6">
            <h2 className="text-lg font-bold text-premium-gold">Practice with client</h2>
          ...
          >
            <div className="mx-auto flex w-full max-w-3xl flex-1 flex-col">
              <div className="flex items-center justify-between gap-4">
                <p className="text-xs font-bold uppercase tracking-widest text-premium-gold">Practice call mode</p>
                <button
                  type="button"
              ...
              <div className="mt-6 flex-1 overflow-y-auto rounded-2xl border border-premium-gold/25 bg-[#121212] p-6">
                ...
                <p className="mt-6 text-lg font-semibold text-premium-gold">{demoScript.closingQuestion}</p>
              ...
              <Link
                ...
                className="mt-4 block text-center text-sm font-semibold text-premium-gold hover:underline"
              >
