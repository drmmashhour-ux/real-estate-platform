...
export function ExpertBillingClient() {
  ...
  async function startSubscribe(plan: "pro" | "premium") {
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="rounded-xl border border-white/10 p-5" style={{ background: CARD }}>
          ...
          <p className="mt-3 text-2xl font-bold capitalize text-white">{data.plan}</p>
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            ...
            >
              {loadingCheckout === "sub:pro" ? "Redirecting…" : "Upgrade to Pro"}
            </button>
            <button
              type="button"
            ...
            >
              {loadingCheckout === "sub:premium" ? "Redirecting…" : "Upgrade to Premium"}
            </button>
          </div>
        </div>
