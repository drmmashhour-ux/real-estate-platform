...
export default async function FsboSellPage({
  ...
  return (
    <>
      ...
      {/* 1. Hero */}
      <section className="border-b border-white/10 bg-[#0B0B0B] px-4 py-14 sm:px-6 sm:py-20 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          <p className="text-xs font-semibold uppercase tracking-[0.25em]" style={{ color: GOLD }}>
            FSBO · Sell yourself
          </p>
          <h1 className="font-serif mt-4 text-3xl font-semibold tracking-tight sm:text-4xl lg:text-5xl">
      ...
      <section id="browse-listings" className="border-t border-white/10 px-4 py-14 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-6xl">
          ...
          {listings.length === 0 ? (
            <p className="mt-12 text-center text-[#B3B3B3]">No listings match your filters yet.</p>
          ) : null}
        </div>
      </section>
    </main>
