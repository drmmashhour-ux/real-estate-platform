    ...
    <div className="grid gap-8 lg:grid-cols-2">
      ...
      <div className="space-y-4">
        <div className="rounded-2xl border border-premium-gold/35 bg-gradient-to-br from-black/80 to-[#1a1508] p-6">
          <h2 className="text-lg font-semibold text-premium-gold">Estimated welcome tax</h2>
        ...
        <button
          ...
          className="rounded-lg border border-premium-gold/50 px-4 py-2 text-sm text-premium-gold disabled:opacity-40"
        >
          Download PDF
        </button>
