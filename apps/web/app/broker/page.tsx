    ...
    <main className="min-h-screen bg-slate-950 text-slate-50">
      <section className="border-b border-slate-800 bg-slate-950/80">
        <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6 sm:py-12 lg:px-8">
          ...
          <div className="mt-4 flex flex-wrap gap-3">
            <Link href="/projects" className="text-sm font-medium text-emerald-400 hover:text-emerald-300">
              Browse properties →
            </Link>
          ...
          <p className="mt-2 text-xs text-slate-500">
            Design Studio opens your own Canva page; create marketing visuals and save them to your listing dashboard.
          </p>
        </div>
      </section>
      <section className="bg-slate-950/90">
        <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6 sm:py-12 lg:px-8">
          ...
          <p className="mt-6 text-sm text-slate-500">Connect your broker account to see clients, leads, and deal pipeline. Use Design Studio (above) to create Canva designs for listings—you get your own Canva page and saved designs appear on the listing page.</p>
        </div>
      </section>
    </main>
  );
