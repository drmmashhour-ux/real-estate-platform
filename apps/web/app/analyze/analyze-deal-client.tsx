...
import { MortgageFinancingBanner } from "@/components/mortgage/MortgageUserHub";
...
export function AnalyzeDealClient({
  ...
  const [city, setCity] = useState<MarketCity>("Montreal");
  ...
  useEffect(() => {
    ...
    const scrollToHash = () => {
      ...
      if (id !== "roi-insights" && id !== "analyzer") return;
