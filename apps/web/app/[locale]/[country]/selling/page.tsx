    ...
    <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6">
      ...
      <ul className="mt-10 grid gap-4">
        <li>
          ...
          >
            <h2 className="text-lg font-semibold text-white">Prestige Direct — sell by yourself</h2>
            <p className="mt-2 text-sm text-[#B3B3B3]">
              Owner-led FSBO lane: Essential &amp; Spotlight publish packages, Suite subscriptions, and your seller dashboard.
            </p>
            <span className="mt-4 inline-block text-sm font-semibold text-premium-gold">Open Prestige Direct →</span>
          </Link>
        </li>
        <li>
          <Link
