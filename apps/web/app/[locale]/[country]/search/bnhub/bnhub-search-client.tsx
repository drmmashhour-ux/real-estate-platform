...
export function BnhubSearchClient() {
  ...
  const dropdownContent = (
    <>
      ...
      {openDropdown === "location" && (
        <div className="w-[min(100vw-2rem,420px)] rounded-xl border border-neutral-200 bg-neutral-100 p-4 shadow-xl">
          ...
          <input
            ...
            className="w-full rounded-lg border border-neutral-200 px-3 py-3 text-base text-slate-900 placeholder:text-slate-400 focus:border-rose-400 focus:outline-none focus:ring-2 focus:ring-rose-400/20"
            autoFocus
          />
          ...
          {recentSearches.length > 0 && locationInput.trim().length < 2 && (
            <div className="mt-3">
              ...
              <ul className="max-h-36 overflow-y-auto rounded-lg border border-neutral-200">
                {recentSearches.slice(0, 6).map((s) => (
                  <li key={s}>
                    <button
                      type="button"
                      className="w-full px-3 py-2 text-left text-sm text-slate-700 hover:bg-neutral-100"
          ...
          {suggestListings.length > 0 && (
            <div className="mt-3">
              ...
              <ul className="max-h-40 overflow-y-auto rounded-lg border border-neutral-200">
            ...
            <ul className="mt-2 max-h-48 overflow-y-auto rounded-lg border border-neutral-200">
              {locationSuggestions.slice(0, 8).map((s) => (
                <li key={s}>
                  <button
                    type="button"
                    className="w-full px-3 py-2.5 text-left text-sm text-slate-700 hover:bg-neutral-100"
                    onClick={() => applyLocationPick(s)}
                  >
                    {s}
                  </button>
      ...
      {/* Dates */}
      {openDropdown === "dates" && (
        <div className="rounded-xl border border-neutral-200 bg-neutral-100 p-4 shadow-xl">
          <div className="grid gap-4 sm:grid-cols-2">
            <div>
              ...
              <input
                ...
                className="w-full rounded-lg border border-neutral-200 px-3 py-2.5 text-slate-900 focus:border-rose-400 focus:outline-none focus:ring-2 focus:ring-rose-400/20"
              />
            </div>
            <div>
              <label className="mb-1 block text-sm font-medium text-slate-700">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="flex h-8 w-8 items-center justify-center rounded-full border border-neutral-300 text-slate-600 hover:bg-neutral-100"
                >
                  −
                </button>
        ...
        <div className="rounded-xl border border-neutral-200 bg-neutral-100 p-4 shadow-xl">
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              className="w-24 rounded-lg border border-neutral-200 px-3 py-2 text-slate-900 focus:border-rose-400 focus:outline-none focus:ring-2 focus:ring-rose-400/20"
            />
      ...
      {openDropdown === "filters" && (
        <div className="max-h-[70vh] w-[320px] overflow-y-auto rounded-xl border border-neutral-200 bg-neutral-100 p-4 shadow-xl">
          <div className="space-y-4">
            <div>
              <label className="mb-1 block text-sm font-medium text-slate-700">
                Property type
              ...
              <select
                ...
                className="w-full rounded-lg border border-neutral-200 px-3 py-2 text-slate-900 focus:border-rose-400 focus:outline-none focus:ring-2 focus:ring-rose-400/20"
              >
            ...
            <div className="flex items-center justify-between gap-3 rounded-lg border border-emerald-200/80 bg-emerald-50/50 px-3 py-2.5">
              ...
              >
                <span
                className={`absolute top-0.5 left-0.5 h-6 w-6 rounded-full bg-neutral-50 shadow ring-1 ring-black/5 transition-transform ${
            ...
            <div>
              ...
              <button
                ...
                className="mt-2 w-full rounded-lg border border-neutral-200 py-2 text-sm font-medium text-slate-700 hover:bg-neutral-100"
              >
  ...
  return (
    <div ref={containerRef} className="lecipm-bg-light-page min-h-screen">
      ...
      <section className="sticky top-0 z-10 border-b border-neutral-200 bg-neutral-50">
        <div className="lecipm-safe-gutter-x mx-auto max-w-7xl py-3">
                  ...
                  <button
                    ...
                    className={`flex items-center gap-2 rounded-full border px-4 py-2.5 text-sm font-medium transition ${
                      openDropdown === btn.id
                        ...
                        : "border-neutral-200 bg-neutral-100 text-slate-700 hover:border-neutral-300 hover:shadow-sm"
                    }`}
                  >
                    <span>{btn.label}</span>
          ...
          <div className="flex items-center justify-between gap-3 lg:hidden">
            <button
              ...
              className="flex flex-1 items-center justify-center gap-2 rounded-full border border-neutral-200 bg-neutral-100 py-3 text-sm font-medium text-slate-700 shadow-sm"
            >
              <span>Filters</span>
              {hasActiveFilters && (
            ...
            <div className="mt-3 flex flex-wrap items-center gap-2">
              {activeTags.map((tag) => (
                <span
                  ...
                  className="inline-flex items-center gap-1 rounded-full border border-neutral-200 bg-neutral-100 py-1.5 pl-3 pr-1.5 text-sm text-slate-700"
                >
                  {tag.label}
                  <button
                    type="button"
      ...
      {mobileFiltersOpen && (
        <div className="fixed inset-0 z-50 flex flex-col bg-neutral-50 lg:hidden">
            ...
            <div className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-neutral-200 px-3 py-2.5 text-slate-900"
                />
                {recentSearches.length > 0 && (
                  <div className="mt-2 flex flex-wrap gap-2">
                    {recentSearches.slice(0, 4).map((s) => (
                      <button
                        ...
                        type="button"
                        onClick={() => applyLocationPick(s)}
                        className="rounded-full border border-neutral-200 px-2 py-1 text-xs text-slate-600"
                      >
                        {s}
                      </button>
                    ))}
              ...
              <div>
                ...
                <div className="mt-2 flex items-center justify-between rounded-lg border border-neutral-200 p-3">
                  <span>Children</span>
                  <div className="flex items-center gap-2">
                    <button
                      type="button"
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full min-h-[48px] rounded-lg border border-neutral-200 px-3 py-2.5 text-base"
                >
                  {PROPERTY_TYPES.map((opt) => (
                    <option key={opt.value || "any"} value={opt.value}>
                      {opt.label}
              ...
              <div className="flex items-center justify-between gap-3 rounded-lg border border-emerald-200/80 bg-emerald-50/50 px-3 py-3">
                ...
                >
                  <span
                    className={`absolute top-1 left-1 h-6 w-6 rounded-full bg-neutral-50 shadow ring-1 ring-black/5 transition-transform ${
              ...
              <div>
                ...
                <button
                  type="button"
                  onClick={useMyLocation}
                  className="mt-2 w-full min-h-[48px] rounded-lg border border-neutral-200 text-sm font-medium text-slate-700"
                >
                  Use my location
                </button>
              </div>
              <Link
                href="/projects"
                className="block rounded-lg border border-dashed border-neutral-300 py-3 text-center text-sm font-semibold text-rose-600"
              >
                  ...
                  {AMENITY_OPTIONS.map((opt) => (
                    ...
                    >
                      <input
                        ...
                        className="h-4 w-4 rounded border-neutral-300 text-rose-500"
                      />
                      {opt.label}
                    </label>
                  ))}
      ...
      {/* Results */}
      <div className="lecipm-safe-gutter-x mx-auto max-w-7xl py-6 md:py-8">
        <div className="flex flex-col gap-6 lg:flex-row lg:gap-8">
          ...
          >
            <div className="mb-4 flex flex-wrap items-center justify-between gap-2">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="rounded-lg border border-neutral-200 bg-neutral-100 px-3 py-2 text-sm font-medium text-slate-700 hover:bg-neutral-200/40 lg:hidden"
                >
                ...
                className="rounded-lg border border-neutral-200 bg-neutral-100 px-3 py-2 text-sm text-slate-700"
              >
            ...
            {loading ? (
              <div className="grid gap-6 sm:grid-cols-2 xl:grid-cols-3">
                {Array.from({ length: 9 }).map((_, i) => (
                  <div
                    key={i}
                    className="flex flex-col overflow-hidden rounded-2xl border border-neutral-200 bg-neutral-100"
                  >
              ...
              <div className="rounded-2xl border border-neutral-200 bg-neutral-100/50 p-10 text-center sm:p-12">
                <h2 className="text-lg font-semibold text-slate-900">
                  {t("search.noProperties")}
                </h2>
                <p className="mx-auto mt-3 max-w-md text-sm leading-relaxed text-slate-600">
                  Try different dates, widen the map area, or clear filters — featured stays are a tap away.
                </p>
                <div className="mt-2 flex flex-wrap justify-center gap-2">
                  <Link
                    href="/bnhub/stays"
                    className="inline-flex min-h-[44px] items-center justify-center rounded-lg border border-neutral-300 bg-neutral-50 px-4 py-2.5 text-sm font-semibold text-slate-800 hover:bg-neutral-100"
                  >
                    Browse featured stays
                  </Link>
                </div>
                <div className="mt-6 flex flex-wrap justify-center gap-3 border-t border-neutral-200 pt-6">
                  <button
                    type="button"
                    onClick={() => {
                      setFilters(defaultFilters);
                    ...
                    className="rounded-lg border border-neutral-300 bg-neutral-100 px-4 py-2 text-sm font-medium text-slate-700 hover:bg-neutral-200/50"
                  >
                    {t("search.browseAll")}
                  </button>
                  <button
            ...
            {loadingMore && (
              <div className="flex justify-center py-6">
                <div className="h-8 w-8 animate-spin rounded-full border-2 border-neutral-200 border-t-rose-500" />
              </div>
            )}
          </div>
          ...
          >
            <div className="mb-2 flex flex-wrap items-center justify-end gap-2">
              ...
              <div
                className="flex rounded-lg border border-neutral-200 bg-neutral-100 p-0.5 text-xs"
                role="group"
                ...
                <button
                  ...
                  className={`rounded-md px-2.5 py-1 font-medium ${
                    mapDisplayMode === "markers"
                      ? "bg-neutral-50 text-slate-900 shadow-sm ring-1 ring-black/5"
                      : "text-slate-600"
                  }`}
                >
                  Markers
      ...
      {savedOpen && (
        <div className="fixed inset-0 z-[60] flex items-end justify-center sm:items-center sm:p-4">
          ...
          />
          <div className="relative max-h-[85vh] w-full max-w-md overflow-hidden rounded-t-2xl bg-neutral-100 shadow-2xl sm:rounded-2xl">
            <div className="flex items-center justify-between border-b border-neutral-200 px-4 py-3">
                ...
                <ul className="space-y-2">
                  {savedList.map((s) => (
                    <li key={s.params}>
                      <button
                        type="button"
                        className="w-full rounded-xl border border-neutral-200 px-4 py-3 text-left hover:border-rose-200 hover:bg-rose-50/50"
                        onClick={() => {
                          setSavedOpen(false);
