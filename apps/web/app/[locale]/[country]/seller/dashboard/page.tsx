        ...
        {listings.length === 0 ? (
          <div className="mt-8">
            <EmptyState
              ...
              description="Finish onboarding if you haven’t — then create a listing. We guide photos, seller declaration, and documents before anything goes live."
            >
              <div className="flex flex-wrap justify-center gap-3">
                ...
                <Link
                  href="/seller/onboarding"
                  className="rounded-xl border border-white/15 px-5 py-2.5 text-sm text-slate-200 transition hover:border-premium-gold/35"
                >
                  Continue onboarding
                </Link>
                <Link
                  href="/explore"
                  className="rounded-xl border border-white/10 px-5 py-2.5 text-sm text-slate-400 transition hover:text-slate-200"
                >
                  Preview buyer search
                </Link>
              </div>
            </EmptyState>
          </div>
