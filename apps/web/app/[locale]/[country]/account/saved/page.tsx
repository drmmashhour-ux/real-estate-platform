  ...
  return (
    <main className="min-h-screen bg-black px-4 py-10 text-zinc-100">
      <div className="mx-auto max-w-3xl">
        ...
        {favs.length === 0 ? (
          <div
            className="mt-10 rounded-2xl border border-zinc-800 p-10 text-center text-sm"
            style={{ background: "#111" }}
          >
            <p className="font-medium text-zinc-200">No saved stays yet</p>
            <p className="mt-2 text-zinc-500">
              Open a BNHub listing and tap the heart — saved stays sync here for faster booking and price checks.
            </p>
            <div className="mt-6 flex flex-col items-stretch justify-center gap-3 sm:flex-row sm:flex-wrap sm:justify-center">
              <Link
                href="/bnhub/stays"
                className="inline-flex min-h-[44px] items-center justify-center rounded-xl px-5 py-2.5 text-sm font-semibold text-black"
              ...
              <Link
                href="/bnhub"
                className="inline-flex min-h-[44px] items-center justify-center rounded-xl border border-zinc-600 px-5 py-2.5 text-sm font-medium text-zinc-300 hover:border-zinc-500 hover:text-white"
              >
                Explore BNHub
              </Link>
            </div>
