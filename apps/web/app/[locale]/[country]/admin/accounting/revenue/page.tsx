...
import { REVENUE_CATEGORIES } from "@/lib/accounting/constants";

export const dynamic = "force-dynamic";

export default async function AdminAccountingRevenuePage() {
  ...
  return (
    <HubLayout title="Revenue ledger" hubKey="admin" navigation={hubNavigation.admin} theme={theme}>
      <div className="space-y-6">
        <AccountingSubnav current="/admin/accounting/revenue" />
        <h1 className="text-xl font-semibold text-white">Revenue ledger</h1>
        <AccountingEntryForm entryType="revenue" categories={REVENUE_CATEGORIES} />
        ...
        <a
          ...
          href="/api/admin/accounting/export?format=csv&type=ledger"
        >
