      ...
      <div className="space-y-8">
        ...
        <section className="rounded-2xl border border-amber-900/35 bg-amber-950/15 px-4 py-4 text-sm text-amber-100/90">
          ...
          <p className="mt-1 text-zinc-400">
            Prioritize flagged inventory and thin copy — cross-check with{" "}
            <Link href="/admin/content-intelligence" className="text-amber-400 underline">
              content intelligence
            </Link>{" "}
            for winners and underperformers. Use{" "}
            <Link href="/admin/ai" className="text-amber-400 underline">
              AI control
            </Link>{" "}
            for description and pricing queues.
          </p>
        </section>
