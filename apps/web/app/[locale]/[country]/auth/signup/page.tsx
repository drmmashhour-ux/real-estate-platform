...
import { SignupPageClient } from "../../signup/signup-page-client";
...
export default async function AuthSignupPage({
  ...
  const acquisitionSrc = params.src?.trim().toLowerCase() ?? "";
  return <SignupPageClient refCode={ref} acquisitionSrc={acquisitionSrc} />;
}
