...
export default async function ResidenceCalendarPage({
  params,
}: {
  ...
  if (!canAccessResidenceDashboard(access) || access.kind === "residence_manager") redirect(`${base}/senior`);

  return (
    <div className="p-6 text-sm text-zinc-100">
      <h1 className="text-xl font-semibold">Visits calendar</h1>
      <p className="mt-2 text-zinc-400">Connect your scheduling provider — placeholder route for visit blocks.</p>
