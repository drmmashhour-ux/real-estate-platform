...
import { BnhubPremiumHostDashboard } from "@/components/bnhub/premium/BnhubPremiumHostDashboard";
  ...
  return (
    <HubLayout
      title={
        <span className="inline-flex items-center gap-2">
          <BnHubLogoMark size="sm" className="max-h-8 sm:max-h-9" />
    ...
    >
      <div className="space-y-8">
        {showAddFirstListing ? (
          <section className="bnhub-card bnhub-card--elevated border-bnhub-gold/25">
            <h2 className="text-lg font-semibold text-bnhub-text">Start hosting</h2>
            <p className="mt-2 text-sm text-bnhub-text-secondary">Add your first listing to start receiving bookings.</p>
            <Link
              href="/dashboard/bnhub/host/new"
              className="bnhub-btn bnhub-btn--primary mt-4 inline-flex w-fit no-underline"
            >
        ...
        <section className="bnhub-card bnhub-card--elevated border-bnhub-gold/20 sm:p-6">
          <BnhubPremiumHostDashboard />
        </section>
