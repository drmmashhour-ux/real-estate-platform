...
export function OnboardingLuxury({ accentColor }: { accentColor: string }) {
  const steps = [
    { label: "Enhanced verification", href: "/dashboard/luxury", desc: "Complete enhanced verification" },
    { label: "Admin approval", href: "/dashboard/luxury", desc: "Luxury listings require admin approval" },
  ];
  return (
    <div className="space-y-4">
      <h2 className="font-semibold text-slate-200">Luxury hub – onboarding steps</h2>
