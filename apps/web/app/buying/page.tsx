...
export default function BuyingHubPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6">
      <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#C9A646]">Buying</p>
      ...
      <ul className="mt-10 grid gap-4 sm:grid-cols-1">
        <li>
          <Link
            ...
            className="block rounded-2xl border border-white/10 bg-white/[0.03] p-6 transition hover:border-[#C9A646]/40 hover:bg-white/[0.05]"
          >
            ...
            <span className="mt-4 inline-block text-sm font-semibold text-[#C9A646]">Learn more →</span>
          </Link>
        </li>
        <li>
          <Link
