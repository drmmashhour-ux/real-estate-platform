...
export function GrowthTrustStrip() {
  return (
    <div className="rounded-2xl border border-[#C9A646]/25 bg-[#0B0B0B] px-4 py-4 sm:px-6">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div>
          <p className="text-xs font-bold uppercase tracking-[0.2em] text-[#C9A646]">Free to get started</p>
  ...
  return (
    <section className="border-t border-white/10 bg-black/40 py-12">
      <div className="mx-auto max-w-6xl px-4">
        <p className="text-center text-xs font-bold uppercase tracking-[0.2em] text-[#C9A646]">Testimonials</p>
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-3">
          {items.map((t) => (
            ...
            >
              ...
              <footer className="mt-3 text-xs text-[#C9A646]">{t.who}</footer>
            </blockquote>
          ))}
        </div>
      </div>
