...
export function ListingUserProvidedDisclaimer({ className = "" }: { className?: string }) {
  return (
    <div
      role="note"
      className={`rounded-xl border border-premium-gold/25 bg-[#0B0B0B]/80 px-3 py-2 text-[11px] leading-relaxed text-[#B3B3B3] ${className}`}
    >
      <p className="font-semibold text-premium-gold/90">Information provided by the user</p>
      <p className="mt-1">
