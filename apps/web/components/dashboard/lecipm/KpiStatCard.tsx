...
export function KpiStatCard({ label, value, sublabel }: Props) {
  return (
    <div className="rounded-2xl border border-premium-gold/20 bg-[#121212] p-5 shadow-[0_0_40px_rgba(0,0,0,0.45)]">
      <p className="text-[10px] font-semibold uppercase tracking-[0.14em] text-premium-gold/90">{label}</p>
