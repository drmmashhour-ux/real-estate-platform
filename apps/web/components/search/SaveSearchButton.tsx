...
export function SaveSearchButton({ tone = "gold" }: { tone?: "gold" | "slate" | "light" }) {
  ...
  const gold =
    "rounded-xl border border-white/15 bg-black/30 px-3 py-2 text-xs font-semibold text-slate-200 hover:border-[#C9A646]/45 hover:text-white disabled:opacity-50";
  const slate =
  ...
  const light =
    "rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 text-xs font-semibold text-slate-700 hover:border-[#C9A646]/50 hover:bg-white disabled:opacity-50";
