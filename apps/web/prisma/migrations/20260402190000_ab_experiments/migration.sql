-- CreateEnum — idempotent: intelligence migration may have created type/tables first (timestamp ordering).
DO $$ BEGIN
...
CREATE INDEX IF NOT EXISTS "experiment_assignments_variant_id_idx" ON "experiment_assignments"("variant_id");
...
CREATE UNIQUE INDEX IF NOT EXISTS "experiment_assignments_experiment_id_session_id_key" ON "experiment_assignments"("experiment_id", "session_id");
...
CREATE INDEX IF NOT EXISTS "experiment_events_event_name_idx" ON "experiment_events"("event_name");
CREATE INDEX IF NOT EXISTS "experiment_events_session_id_idx" ON "experiment_events"("session_id");
