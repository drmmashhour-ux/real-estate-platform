...
export type ComplianceTimelineItem = { id: string; at: string; label: string; detail?: string };

export function ComplianceTimeline(props: { items: ComplianceTimelineItem[] }) {
  return (
    <div className="rounded-xl border border-gray-800 bg-black p-4 text-white">
      <h3 className="text-sm font-semibold text-[#D4AF37] mb-3">Compliance timeline</h3>
