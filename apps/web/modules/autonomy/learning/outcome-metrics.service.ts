...
import type { OutcomeMetrics } from "./learning.types";

const ZERO: OutcomeMetrics = {
  grossRevenue: 0,
  occupancyRate: 0,
  bookingCount: 0,
  adr: 0,
...
export async function loadObservedMetrics(scopeType: string, scopeId: string): Promise<OutcomeMetrics> {
