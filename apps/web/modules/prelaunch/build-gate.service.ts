...
export function runBuildGate(opts: BuildGateOptions): { steps: BuildStepResult[]; blockingFailures: string[] } {
  ...
  steps.push(
    runStep("prisma_validate", pnpm, ["exec", "prisma", "validate", "--schema=./prisma/schema.prisma"], opts.cwd),
  );
  steps.push(
    runStep("prisma_generate", pnpm, ["exec", "prisma", "generate", "--schema=./prisma/schema.prisma"], opts.cwd),
  );
