...
<header style="border-bottom:2px solid #D4AF37;padding-bottom:12px"><h1 style="margin:0">Cooperation agreement (broker–broker)</h1><p style="font-size:13px">Ref: ${esc(v.ref)} · ${esc(v.generatedAt)}</p></header>
