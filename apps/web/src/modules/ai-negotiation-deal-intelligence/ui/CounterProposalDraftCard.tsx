  ...
  return (
    <div className="rounded-2xl border border-white/10 bg-gradient-to-b from-[#141414] to-[#0a0a0a] p-6 shadow-xl ring-1 ring-white/5 print:border-neutral-400 print:bg-white print:text-black print:shadow-none">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          <p className="text-[10px] font-semibold uppercase tracking-[0.14em] text-premium-gold print:text-neutral-800">Counter-proposal draft</p>
      ...
      <button
        ...
        className="mt-4 rounded-full border border-premium-gold/50 bg-premium-gold/10 px-5 py-2 text-xs font-semibold text-premium-gold transition hover:bg-premium-gold/20 disabled:opacity-50 print:hidden"
      >
