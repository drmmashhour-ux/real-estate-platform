  ...
  return (
    <div className="rounded-xl border border-white/10 bg-black/20 p-3">
      ...
      <div className="mt-2 flex flex-wrap gap-2">
        ...
        <button type="button" className="rounded-md bg-premium-gold px-3 py-1 text-xs font-medium text-black" onClick={() => { if (!text.trim()) return; onAsk(text.trim(), sectionKey.trim() || undefined); setText(""); }}>
          Send
        </button>
      </div>
    </div>
