...
export async function ensureAiModels() {
  const defaults = [
    { key: "fraud", name: "Fraud risk", description: "Aggregates fraud signals into entity risk score", active: true },
    { key: "pricing", name: "Dynamic pricing", description: "Nightly price and demand recommendations", active: true },
    { key: "ranking", name: "Search ranking", description: "Listing ranking score and factors", active: true },
    { key: "demand", name: "Demand forecast", description: "Regional demand and supply gap", active: true },
  ];
