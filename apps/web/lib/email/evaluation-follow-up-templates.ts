...
<div style="font-family:system-ui,sans-serif;font-size:16px;line-height:1.55;color:#111;max-width:560px;">
  ...
  <p><a href="${escapeHtml(consultUrl)}" style="color:#0B0B0B;background:#C9A646;padding:10px 18px;border-radius:8px;font-weight:700;text-decoration:none;display:inline-block;">Request a precise evaluation</a></p>
...
<div style="font-family:system-ui,sans-serif;font-size:16px;line-height:1.55;color:#111;max-width:560px;">
  ...
  <p><a href="${escapeHtml(consultUrl)}" style="color:#0B0B0B;background:#C9A646;padding:10px 18px;border-radius:8px;font-weight:700;text-decoration:none;display:inline-block;">Book your free consultation</a></p>
