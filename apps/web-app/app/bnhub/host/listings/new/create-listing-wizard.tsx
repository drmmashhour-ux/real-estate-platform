  ...
  async function handleSubmit() {
    ...
    try {
      const payload = {
        ...
        nightPriceCents: Number(data.nightPriceCents) || 0,
        ...
        taxRatePercent: data.taxRatePercent ? parseFloat(data.taxRatePercent) : undefined,
        ...
        {step === 4 && (
          <>
            ...
            <div className="mt-4 space-y-4">
              ...
              <div>
                <label className="mb-1 block text-xs text-slate-400">Tax rate % (optional)</label>
                <input
                  type="number"
                  min={0}
                  max={100}
