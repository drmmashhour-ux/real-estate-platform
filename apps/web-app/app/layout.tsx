        ...
        <div className="flex min-h-screen flex-col">
          <header className="border-b border-slate-800 bg-slate-950/80 backdrop-blur">
            <div className="mx-auto flex max-w-6xl items-center justify-between gap-6 px-4 py-4 sm:px-6 lg:px-8">
              ...
              <nav className="flex flex-wrap items-center gap-4 text-xs font-medium text-slate-300 sm:text-sm">
                <a href="/" className="hover:text-emerald-300">
                  Home
                </a>
                <a href="/marketplace" className="hover:text-emerald-300">
                  Marketplace
                </a>
                <a href="/bnhub" className="hover:text-emerald-300">
                  Short-term rentals
                </a>
                <a href="/bnhub/trips" className="hover:text-emerald-300">
                  My trips
                </a>
                <a href="/messages" className="hover:text-emerald-300">
                  Messages
                </a>
                <a href="/broker" className="hover:text-emerald-300">
                  Broker CRM
                </a>
                <a href="/owner" className="hover:text-emerald-300">
                  Owner dashboard
                </a>
                <a href="/about-platform" className="hover:text-emerald-300">
                  About platform
                </a>
                <a href="/contact" className="hover:text-emerald-300">
                  Contact
                </a>
                <a href="/admin" className="hover:text-emerald-300">
                  Admin
                </a>
