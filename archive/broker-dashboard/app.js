(function () {
  ...
  function showLogin() {
    ...
    localStorage.removeItem("broker_accessToken");
  ...
  form.addEventListener("submit", async (e) => {
    ...
    try {
      ...
      if (data.accessToken) localStorage.setItem("broker_accessToken", data.accessToken);
      if (data.user) localStorage.setItem("broker_user", JSON.stringify(data.user));
