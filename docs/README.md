...
- **Starting marketing for LECIPM?** [Marketing Starter Toolkit](marketing/LECIPM-MARKETING-STARTER-TOOLKIT.md) — platform goals, user segments, value by user, how users use the platform, channel/tool stack, and platform identity card.
